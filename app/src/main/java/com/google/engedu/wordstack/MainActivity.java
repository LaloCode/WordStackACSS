...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while((line = in.readLine()) != null) {
                ...
                /* Check if a word is equals to WORD_LENGTH, if so then add it to the arrayList*/
    ...
    public boolean onStartGame(View view) {
        ...
        while (true) {
            ...
            if (randomNum == 0 && counter1 < WORD_LENGTH) {
                scrambledWord += word1.charAt(counter1);
                counter1++;
            } else if (counter2 < WORD_LENGTH) {
                scrambledWord += word2.charAt(counter2);
                counter2++;
            } else if (counter1 == WORD_LENGTH && counter2 == WORD_LENGTH) {
                break;
            }
        }
